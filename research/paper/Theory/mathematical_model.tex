...
\caption{Induced angle of attack on the square prism due to the resultant of free-stream velocity of the fluid and transverse velocity of the body. \JL{The angle of attack $\theta$ is not marked on the figure!} }
\label{fig:setup_1}
\end{figure}
