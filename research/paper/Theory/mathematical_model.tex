...
\end{equation}
 ...
 \Tan{You need to talk about Figure 2. How your Re165 compares with earlier results. Highlight the main differences between RE165 and Re22300. What are the peak value in both. When do they become negative and why that is significant (i.e. idrection of power transfer). Also worh mentioning that the inflcection point at ?? degrees leads to the hystersis and cite some key papers for that. Then say this is not present at RE165 and therefore expect no hyterisis at 165. The overall smaller Cy and smaller range of angles where Cy is +ve for Re165 compared to Re22300 leads one to expect a lot less power at re165 compared to re22300.
Fix this up and then  we can later in the results section relate back to here to aid in our explanation.}
